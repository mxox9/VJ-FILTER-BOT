...
# Bot information
SESSION = environ.get('SESSION', 'Mixy Movie')
...
PICS = (environ.get('PICS', 'https://i.ibb.co/Z1M8qtfk/IMG-20250824-220325.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6052975324').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002753905287'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002828209150').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002626430523') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002753905287')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://saifulmolla79088179:8KBVaydhbkRi134U@cluster0.uolhbei.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "mixyox_db")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'user')
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://saifulmolla79088179:jcymRLzAYCTyJ21W@cluster0.eu7n71f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'logoxchnl') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mixy_ox')
CHNL_LNK = environ.get('CHNL_LNK', 'https://mixy_ox')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moxy_ox') # Support Chat Link Without https:// or @
